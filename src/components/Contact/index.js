    ...
    <Container className="about-me mt-5 p-5 text-white text-center">
      <Row xs={4} lg={10}>
        <Col xs={12} lg={12}>
          ...
          <h2 className="h2">Résumé: <a href="assets/documents/Nicholas-Podniestrzanski-Resume_020921.pdf" download><i className="material-icons medium">cloud_download</i></a></h2>
        </Col>
      </Row>
    </Container>
  );
